    ...
    <PublicRoute>
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-gray-100">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl transition-all duration-300 hover:shadow-blue-200">
          <h1 className="mb-8 text-center text-3xl font-extrabold text-blue-700 tracking-tight">Welcome Back</h1>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="/auth/signup" className="font-medium text-blue-600 hover:underline transition-colors duration-150">
              Sign up
            </a>
          </p>
        </div>
